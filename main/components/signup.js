  ...
  return (
    <div className={styles["signup-page"]} style={{backgroundColor:theme.setBg}}>
      <div className={styles['navig-side']}>
       <div  className={styles['l-div']} style={{color:theme.setColor}}   onClick={()=>redirect.replace('/')}>Home</div>
       <ThemeSwitch/>
       </div>
      ...
      >
        ...
        <div className={styles["signup-form"]} style={{backgroundColor:theme.setButtonColor,color:theme.setTextColor}}>
          ...
          <button type="submit" className={styles["signupsbmt"]} disabled={disabled}  style={{backgroundColor:theme.setBg,color:theme.setColor}}>
            {disabled?<div class={styles["lds-ring"]}><div></div><div></div><div></div><div></div></div>:'Signup'}
          </button>
          <button  style={{color:theme.setTextColor,backgroundColor:theme.setButtonColor,border:'none'}} onClick={(e)=>redirect.replace('/login')}>Already have an account?</button>
        </div>
      </form>
      </div>
    </div>
