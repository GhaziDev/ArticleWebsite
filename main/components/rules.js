...
import styles from '../styles/styling/rules.module.css'
...
const Rules = () => {
  ...
  return (
    <div className={styles['open-div']}>
      ...
      <span className={styles['rules-span']}></span>
      <Dialog  open={open} onClose={() =>setOpen(false)} className={styles["drules"]}>
        <div
          className={styles["rules-div"]}
